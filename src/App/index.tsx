...
import { SiReact, SiPython, SiHeroku, SiNextDotJs, SiXcode } from 'react-icons/si'
import {
  FiCode,
  FiGithub,
  FiLinkedin,
  ...
  return (
    <div className="flex flex-row justify-center items-center min-h-full bg-app-background bg-center bg-no-repeat bg-cover">
      {!isLoading && (
        ...
        >
          <div
            className="py-8 px-8 lg:px-4 bg-white bg-opacity-10 flex flex-col w-full lg:w-auto lg:max-w-xs"
            style={{
              backdropFilter: 'blur(10px)',
            }}
          >
          ...
          <div className="flex-1 p-4 lg:p-6">
            <div className="text-lg text-white font-black mb-8 flex items-center">
              <FiCode />
              <div className="ml-4">Full Stack Coding Engineering Skills</div>
            </div>
            ...
            <div className="grid grid-rows-4 grid-cols-1 gap-4 md:grid-rows-2 md:grid-cols-2">
               <KnowledgeLevel
                ...
                languageName="Basics"
                experience="The Basics of programming language JavaScript, CSS HTML. I already created many websites using React, Vue Angular bootstrap as well as mobile apps with React Native. I am currently learning more about AWS and Cloud Computing."
              />

              <KnowledgeLevel
                iconComponent={<SiHeroku/>}
                languageName="Workflow & Tools"
                experience="Github, Vercel, Heroku and majority of my Full Stack coding skills were acquired at Denver University. Now Experimenting with supabase and Firebase. Ive created many full stack applications using the MERN stack and LAMP stack."
              />
              ...
              <KnowledgeLevel
                ...
                languageName="Front End Dev & Design"
                experience="For design UX/UI Chat GPT, Blender and Adobe XD. HTML, CSS, SASS/SCSS, DOM, API, AJAX/Fetch, React, Vue, Angular, Next.js. I will have all the experience you need as a base line and am very quickly adaptable. I love to design and create awesome user experiences."
              />
              <KnowledgeLevel
                iconComponent={<SiXcode />}
                languageName="Solana Fighter"
                experience="Showcase link coming soon. Check it out on Github."
              />
              <KnowledgeLevel
                iconComponent={<SiXcode />}
                languageName="Destination Weather APP"
                experience="Showcase link coming soon. Check it out on Github."
              />
            </div>
          </div>

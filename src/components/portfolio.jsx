            ...
            <div className="col-sm-12">
              <div className="title-box text-center">
                ...
                <p className="subtitle-a">
                  Here are some of my in class full stack applications and projects!
                </p>
              ...
              <div className="work-box">
                <a href={stock} data-lightbox="gallery-vmarine">
                  <div className="work-img">
                    <img src={stock} href="https://clf9008.github.io/Project1/" alt="" className="img-fluid" />
                  </div>
                  <div className="work-content">
                    <div className="row">
                      <div className="col-sm-8">
                        <h2 className="w-title">Travel Destination Weather</h2>
            ...
            <div className="col-md-4">
              <div className="work-box">
                <a href={stock1} data-lightbox="gallery-aguadeluz">
                  <div className="work-img">
                    <img src={stock1} href="https://gerweckevan.github.io/work-calendar/" alt="" className="img-fluid" />
                  </div>
                  <div className="work-content">
                    <div className="row">
                      <div className="col-sm-8">
            ...
            <div className="col-md-4">
              <div className="work-box">
                <a href={stock4} data-lightbox="gallery-smth">
                  <div className="work-img">
                    <img src={stock4} href="https://gentle-brook-68093.herokuapp.com/view" alt="" className="img-fluid" />
                    
                  </div>
                  <div className="work-content">
                    <div className="row">
                      <div className="col-sm-8">
                        <h2 className="w-title">Du OnTrack</h2>
                        <div className="w-more">
            ...
            <div className="col-md-4">
              <div className="work-box">
                <a href={stock5} data-lightbox="gallery-mf">
                  <div className="work-img">
                    <img src={stock5} href="https://creativeartistdesign.business/" alt="" className="img-fluid" />
                  </div>
                  <div className="work-content">
                    <div className="row">
                      <div className="col-sm-8">
                        <h2 className="w-title">Creative Artist Design</h2>
                        <div className="w-more">
                          <span className="w-ctegory">
                          </span>
                        </div>
